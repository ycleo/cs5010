...
public class IndividualFilerTest {
  ...
  void setUp() {
    ...
    testIndividualFiler = new IndividualFiler(testContactInfo, 600000.0, 60000.0, testTaxMitigateExpense);
  }
  ...
  void calculateSavingsDeduction() {
    Double expectedSavingsDeduction = (testTaxMitigateExpense.getSavings().getRetireSavings() + testTaxMitigateExpense.getSavings().getHealthSavings()) * 0.7;
  ...
  @Test
  void calculateTaxes() {
    Double expectedTaxes = (testIndividualFiler.calculateBasicTaxableIncome() - testIndividualFiler.calculateSavingsDeduction() - testIndividualFiler.calculateHouseExpenseDeduction()) * 0.19;
